...
export const themind: Character = {
  ...
  skills: [
    ...
    },
    {
      ...
      description: "Hijacks the crowd's energy. Drains 2 energy from the opponent and converts it for own use.",
    ...
    },
    {
      id: 'mind_s3',
      name: 'Taunt',
      description: "Gets so deep inside the opponent's head they can't function. Stuns one target for 2 rounds.",
