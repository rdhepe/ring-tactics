  ...
  skills: [
    {
      ...
      description: 'Bounces off the ropes and launches a flying kick for 25 damage.',
    ...
    },
    {
      id: 'phantom_s3',
      name: 'Momentum',
      description: 'Builds ring momentum for 3 rounds. Attacks deal 10 more damage and he gains 1 Agility energy each round.',
      ...
      effects: [
        ...
        { type: 'energy_gain',  value: 1,  duration: 3, target: 'self', energyType: 'agility' },
      ],
    },
    {
      id: 'phantom_s4',
