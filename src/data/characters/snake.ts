...
export const snake: Character = {
  ...
  skills: [
    ...
    },
    {
      id: 'snake_s2',
      name: "Viper's Grip",
      description: 'Digs thumbs into pressure points. The opponent takes 15 affliction damage each round for 3 rounds. Cannot be reduced.',
      iconColor: 'bg-green-800',
      iconUrl: vipersGripImg,
      cost: { agility: 1, random: 1 },
      cooldown: 0,
      targetType: 'enemy',
      mainClass: 'physical',
      persistence: 'action',
    ...
    },
    {
      id: 'snake_s3',
      name: 'Choke Hold',
      description: 'Clamps on a rear naked choke. Target cannot act for 1 round.',
